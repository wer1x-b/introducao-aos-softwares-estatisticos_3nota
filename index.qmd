...
# Gerando gráfico (sem otimização, pois envolve matplotlib)
def visualizar_aproximacao(num_pontos_plot):
    dentro_x, dentro_y = [], []
    fora_x, fora_y = [], []
...
# Medindo tempo de execução da função otimizada
start = time.time()
pi_aprox = aproximar_pi_calculo_numba(100_000)
end = time.time()
print(f"π ≈ {pi_aprox:.5f}")
